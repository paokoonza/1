...
cl = LINETCR.LINE()
cl.login(token='EoUo2x5egHsQKkQWdny9.nnBoNbIlLHC3yh3xiCI2kq.MCH35k1yV1ZfiH0xobpMa8K83j2+B6CHUc0kr0vkZFw=')
cl.loginResult()

#ki1 = SATAN.LINE()
#ki1.login(token='Your_Token_Here')
#ki1.loginResult()

#ki2 = SATAN.LINE()
#ki2.login(token='Your_Token_Here')
#ki2.loginResult()

#ki3 = SATAN.LINE()
#ki3.login(token='Your_Token_Here')
#ki3.loginResult()

#ki4 = SATAN.LINE()
#ki4.login(token='Your_Token_Here')
#ki4.loginResult()

#ki5 = SATAN.LINE()
#ki5.login(token='Your_Token_Here')
#ki5.loginResult()

#ki6 = SATAN.LINE()
#ki6.login(token='Your_Token_Here')
#ki6.loginResult()

#ki7 = SATAN.LINE()
#ki7.login(token='Your_Token_Here')
#ki7.loginResult()
...
#=====================================================================================
            elif msg.text.lower() == "Botremovesiri":
                stn = [mid,ki1]
                if msg.from_ == stn:
                    if msg.toType == 2:
...
#=====================================================================================
                ...
                cl.sendText(msg.to,str(datetime.datetime.now() - start_runtime)[:-7].split(":")[0]+" ชั่วโมง "+str(datetime.datetime.now() - start_runtime)[:-7].split(":")[1]+" นาที "+str(datetime.datetime.now() - start_runtime)[:-7].split(":")[2]+" วินาที")
#=====================================================================================
            elif ("Gn:" in msg.text):
                if msg.toType == 2:

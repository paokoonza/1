...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EonP24ckSJ00yPeZYKp7.QTjneaJ3YUJ4UnQPQrKYTW.THlUmCWKu8DkDVw8ngFwwn5e1Yq6XaAhB3asmx39sVE=")
cl.loginResult()
...
¢w¢w?ùù?===========?ùù?¢w¢w
        [By.???????????]
          [By.????????????]
¢w¢w?ùù?===========?ùù?¢w¢w
ùÝùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùù
ùø???????????????
ùàùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùù
ùø???¡¸?  id 
ùø???¡¸?  Mid
ùø???¡¸?  All mid:
ùø???¡¸?  Me 
ùø???¡¸?  All mid
ùø???¡¸?  [K1/K2/K3/]: "Contact"
ùø???¡¸?  [K1/K2/K3 fuck:]: "Kick kicker"
ùø???¡¸?  [Group Id]: "Id Me Group"
ùø???¡¸?  [TL : "Text"]: "Auto status TL"
ùø???¡¸?  [Clock :]: "Name Clock"
ùø???¡¸?  Set
ùø???¡¸?  [Up clock]: "Up date Clock"
ùø???¡¸?  [Name : 'text']: "Name me"
ùø???¡¸?  MIC]: "mid"]: "Contact share"
ùø???¡¸?  [Massage add: "text"]: 
ùø???¡¸?  [Add confirmasi]: 
ùø???¡¸?  [Comment set : "Text"]:
ùø???¡¸?  [Comment check]: 
ùø???¡¸?  [Clock: on]: "Clock name on"
ùø???¡¸?  [Clock: off]: "Clock name off"
ùø???¡¸?  [Ban]: "Add blacklist"
ùø???¡¸?  Unban]: "Dalate blacklist"
ùø???¡¸?  [Banlist]: "Check blacklist"
ùø???¡¸?  [Kicker join]
ùø???¡¸?  Kick
ùø???¡¸?  [Contact: on/off]: 
ùø???¡¸?  [Auto join: on/off]: 
ùø???¡¸?  [Cancel Invite: 1 on/off]:
ùø???¡¸?  [Auto share: on/off]:
ùø???¡¸?  Speed / Sp
ùø???¡¸?  [Auto leave: on/off]: 
ùø???¡¸?  [Comment: on/off]: 
ùø???¡¸?  [Auto add: on/off]: 
ùø???¡¸?  [Auto like: on/off]: 
ùø???¡¸?  [Ban " @Tag]: 
ùø???¡¸?  [Unban " @Tag]: 
ùø???¡¸?  [Urlon]: "Open urL"
ùø???¡¸?  [Urloff]: "Closed urL"
ùø???¡¸?  [Url]: " Check urL room"
ùø???¡¸?  [Ginfo]: "~Ã·~ data room"
ùø???¡¸?  [Invite: "mid"]: 
ùø???¡¸?  [Cancel]: "Cancel invite"
ùø???¡¸?  [Gn: "name"]: "Change name Group"
ùãùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùù
"""
helpMessage2 ="""?¨Å¤á??? Î²Ç¾Å¦ ?«á??áž¶à®¤à?àª¯à??“àº®à¸µâœ¨
...
admins = ["ua1cb6e845fe8f2646fe8a5c598a5c5911841fa"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"Auto like By.?¨Å¦Î?„â„³???«á??áž¶à®¤à?àª¯à??“àº®à¸µâœ¨ ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 26:
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["?›ã®?—ãƒ¬?¼ãƒ³??1?7","K1 gift"]:
                msg.contentType = 9
                ...
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["?›ã®?—ãƒ¬?¼ãƒ³??1?7","K2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["?›ã®?—ãƒ¬?¼ãƒ³??1?7","K3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
                msg.text = None
                ks.sendMessage(msg)
            elif msg.text in ["?›ã®?—ãƒ¬?¼ãƒ³??1?7","K4 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
                msg.text = None
                kc.sendMessage(msg)
            elif msg.text in ["?›ã®?—ãƒ¬?¼ãƒ³??1?7","K5 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
            ...
            elif msg.text in ["?³ãƒ¡?³ã?:?ªãƒ³","Comment:on"]:
            ...
            elif msg.text in ["?³ãƒ¡?³ã?:?ªã?","Comment:off"]:
                ...
                if msg.from_ in Administrator:
                    ...
                    cl.sendText(msg.to,"?Ô¼Ô¼????")
                else:
                    cl.sendText(msg.to,"?Ô¼Æ¦???Æ³")
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(group)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Æ²Æ¦Ô¼ ?? ?Ô¼Æ¦???Æ³??1?7")
                    else:
                        cl.sendText(msg.to,"?Ô¼Æ¦???Æ³ Æ²Æ¦Ô¼??")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"It can't be used besides the group??")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if ginfo.preventJoinByTicket == True:
                            ...
                            u = "è¨±å¯"
                        cl.sendText(msg.to,"[?Æ¦?Æ²Æ¤]\n" + str(ginfo.name) + "\n\n[???]\n" + msg.to + "\n\n[?Æ¦?Æ²Æ¤ ?Æ¦??Æ¬?Æ¦]\n" + gCreator + "\n\n[Æ¤Æ¦???Ô¼ ?Æ¦?Æ²Æ¤]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus + "\n\nM?M??Æ¦:" + str(len(ginfo.members)) + "Person\n????Æ¬?:" + sinvitee + "Person\n????Æ¬?Æ¬??? Æ²Æ¦Ô¼:" + u + "?Æ¬'Æ§ Æ¬H? ??Æ§???.")
                    else:
                        cl.sendText(msg.to,"[?å?]\n" + str(ginfo.name) + "\n[gid]\n" + msg.to + "\n[å°ç??„ä??è€…]\n" + gCreator + "\n[å°ç??¾æ?]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus)
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"It can't be used besides the group??")
                    else:
...
#--------------------------------------------------------
                ...
                if wait["leaveRoom"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Æ¬Æ²Æ¦??? ?????")
            elif msg.text in ["?±æ?:?ªãƒ³","?±æ?ï¼šã‚ª??","Auto share:on"]:
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"?Ô¼Æ¦???Æ³ ??")
                    else:
            ...
            elif msg.text in ["?±æ?:?ªã?","?±æ?ï¼šã‚ª??","Auto share:off"]:
                ...
                if wait["likeOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already??")
            elif msg.text in ["?„ã???:?ªã?","Auto like:off"]:
            ...
            elif msg.text in ["Add confirmasi","?ªå?è¿½å??å€™è?ç¢ºè?"]:
                if wait["lang"] == "JP":
            ...
            elif msg.text in ["CHANGE","è¨€èªžè???"]:
                if wait["lang"] =="JP":
                    wait["lang"] = "TW"
                    cl.sendText(msg.to,"??Æ²?Æ¬Æ¦Æ³ Ô¼???Æ²??? ?Æ²Æ¦??? ? ?H??????")
                else:
                    wait["lang"] = "JP"
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"?Æ¬ ???'Æ¬ ?? Æ²Æ§?? ??Æ§???Æ§ Æ¬H? ?Æ¦?Æ²Æ¤.??")
                    else:
                        cl.sendText(msg.to,"?MÆ¤?Æ§Æ§??Ô¼? Æ²Æ§? ??Æ§???Æ§ Æ¬H? ?Æ¦?Æ²Æ¤. ")
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"??Æ¬ ??Æ¦ Æ²Æ§? Ô¼?Æ§Æ§ Æ¬H?? ?Æ¦?Æ²Æ¤")
            elif msg.text in ["cb"]:
                wait["wblack"] = True
...
#-----------------------------------------------------------                          
				...
				if msg.from_ in OWN:
					...
					if targets == []:
						sendMessage(msg.to,"Æ²Æ§?Æ¦ ???Æ§ ??Æ¬ ?Ò²?Æ§Æ¬")
						pass
					else:
						for target in targets:
							try:
                ...
                if msg.toType == 2:
                    if msg.from_ in admin:                                        
                       ...
                       if targets == []:
                           cl.sendText(msg.to,"Æ²Æ§?Æ¦ ???Æ§ ??Æ¬ ?Ò²?Æ§Æ¬")
                           pass
                       else:
                            for target in targets:
                                try:
...
#-----------------------------------------------------------
				...
				gid = msg.to
				autocancel[gid] = "poni"
				cl.sendText(msg.to,"Æ¤Æ¦?Æ¬??Æ¬ ????Æ¬?Æ¬??? ??")
...
#-----------------------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(msg.to,"?Æ¬? Æ§Æ¤?M Æ¬?Æ¦??Æ¬ ??")
                       ...
                       kk.sendText(g.mid,"Spam  ??")
                       ks.sendText(g.mid,"Spam  ??")
                       kc.sendText(g.mid,"H?H?H? ?? Æ§Æ¤?M  ??")
                       ka.sendText(g.mid,"H?H?H? ?? Æ§Æ¤?M  ??")
                       ks.sendText(g.mid,"H?H?H? ?? Æ§Æ¤?M  ??")
                       cl.sendText(msg.to, "???? Æ§Æ¤?M  ??")
                       print "Done spam" 
#-----------------------------------------------------------
            elif msg.text in ["PING","Ping","ping"]:
                ki.sendText(msg.to,"Æ¤??? ???„»double thumbs up?¿¿????Har Har?¿¿")
                kk.sendText(msg.to,"Æ¤??? ???„»double thumbs up?¿¿????Har Har?¿¿")
                ks.sendText(msg.to,"Æ¤??? ???„»double thumbs up?¿¿????Har Har?¿¿")
                kc.sendText(msg.to,"Æ¤??? ???„»double thumbs upï¿½ô?1?7???Har Harï¿?1?7")
                ka.sendText(msg.to,"Æ¤??? ???„»double thumbs upï¿½ô?1?7???Har Harï¿?1?7")
#----------------------------------------------------------
            elif msg.text in ["Respon","respon","responsename"]:
                cl.sendText(msg.to,"???Æ¬?Æ¦ ??Æ²? ??Æ¬ Ô¼??? ?.2 ????")
                ki.sendText(msg.to,"??Æ¬ Ô¼??? 1")
                kk.sendText(msg.to,"??Æ¬ Ô¼??? 2")
                ks.sendText(msg.to,"??Æ¬ Ô¼??? 3")	
                kc.sendText(msg.to,"??Æ¬ Ô¼??? 4")
                ka.sendText(msg.to,"??Æ¬ Ô¼??? 5")
#----------------------------------------------------------
            elif msg.text == "à¸¡à¸­à¸?1?7":
              if msg.from_ in admin:
                cl.sendText(msg.to, "Æ§?Æ¬ Æ¬H? Ô¼?Æ§Æ¬Æ§???Æ§' Æ¤???Æ¬(ï½?1?7?»Ï‰ãƒ»Â´)")
                try:
		  ...
		  if msg.to in wait2['readPoint']:
	            ...
	            cl.sendText(msg.to, " %s\n\n\nPeople who have ignored reads\n(ï½?1?7?»Ï‰ãƒ»Â´)\n%s\n\nThese anu anu uesrs have seen at the lastseen point(ï½?1?7?»Ï‰ãƒ»Â´)\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
	          else:
	            cl.sendText(msg.to, "Sider ga bisa di read cek setpoint dulu bego tinggal ketik\nSetlastpoint\nkalo mau liat sider ketik\nViewlastseen")
#-----------------------------------------------------------speed
            elif msg.text in ["Ban"]:
                wait["wblacklist"] = True
                cl.sendText(msg.to,"Æ¤Ô¼??Æ§? Æ§??? Æ¬H? ????Æ²?Æ¬ Æ¦???Æ§Æ¬?Æ¦?? ??Æ¬H ? ?Ô¼???Ô¼?Æ§Æ¬??1?7")
            elif msg.text in ["Unban"]:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"Æ¤Ô¼??Æ§? Æ§??? Æ¬H? ????Æ²?Æ¬ Æ¦???Æ§Æ¬?Æ¦?? ??Æ¬H ? ?Ô¼???Ô¼?Æ§Æ¬??1?7")
            elif msg.text in ["Banlist"]:
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"Æ¬H?Æ¦? ?Æ§?'Æ¬ ? Æ¤?Æ¦Æ§?? M??? ? ?Ô¼???Ô¼?Æ§Æ¬.??1?7")
                else:
                    cl.sendText(msg.to,"??Ô¼?? ?Æ§ ? ?Ô¼???Ô¼?Æ§Æ¬??1?7")
                    mc = ""
                ...
                if msg.toType == 2:
                    ...
                    for mm in matched_list:
                        cocoa += "??1?7" +cl.getContact(mm).displayName + "\n"
                ...
                try:
                    ...
                    cl.sendText(msg.to,"?Æ¦Æ¦?Æ¦")
            elif "fakec??1?7" in msg.text:
                try:
                    source_str = 'abcdefghijklmnopqrstuvwxyz1234567890@:;./_][!&%$#)(=~^|'
                    name = "".join([random.choice(source_str) for x in xrange(10)])
                    amid = msg.text.replace("fakec??1?7","")

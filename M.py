...
cl = LINETCR.LINE()
cl.login(token='EoDo53poCFuWzfdTq259.nnBoNbIlLHC3yh3xiCI2kq.fPbScA0w+os2LCHVq+/QftxvSjUioHwB66nFaNZqqBs=')
cl.loginResult()

#ki1 = LINETCR.LINE()
#ki1.login(token='Eo2nDCyDTyjt41ygqEj1.3F5mAYbgAHDqpBJBma2x0q.b/fBojoeO8Vfzrqn37VpMWMWPlaSscfqv/kg8jeZ12w=')
#ki1.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token='EoDe5Sxof7C0YjVE5Svd.f41DoffOio7QHS5kSVyVlq.nPwpd4lVMUSNJYShq1WwhqtR0VU4By7IWgHcWic9srk=')
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token='EojCrYTvn1tj1r09YF81.OFdc2oVa5NtbpXhRKHafmq.p5oNhJS8EzfAKf8wfK5bumtMRtHfTeiSSU8L6SMcXq0=')
#ki3.loginResult()

#ki4 = LINETCR.LINE()
#ki4.login(token='EoR2EZwjspjeIehIx3B3.g3V1VYdjPTVRkLmEcvSbCW.zScGQQf6rK8AX7481BXtEPKH4jDKUfBA2JmNJlOj+xQ=')
#ki4.loginResult()

print "[By.มินทดลองบอท]"
reload(sys)
...
──┅═✥===========✥═┅──
╔════════════════
║[By.มินทดลองบอท]line://ti/p/~socool290
╚════════════════
"""
SiriMessage="""╔════════════════
║คำสั่งบอทสิรินะครับ
